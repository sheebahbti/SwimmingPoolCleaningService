# Swimming Pool Cleaning Service — Summary & Discovery

This document combines the **project summary / build order** with the **pre-build discovery questions** that drove the technology and architecture decisions.
...
## How to Use the Discovery Questions
...
- [SystemDesign.md](SystemDesign.md) — Architecture, key concepts & tech rationale
